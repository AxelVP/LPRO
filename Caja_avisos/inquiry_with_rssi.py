...
class inquiry_rssi ():
    ...
    def device_inquiry_with_with_rssi(self):
        # save current filter
        old_filter = self.sock.getsockopt(bluez.SOL_HCI, bluez.HCI_FILTER, 14)
        ...
        bluez.hci_send_cmd(self.sock, bluez.OGF_LINK_CTL,
                           bluez.OCF_INQUIRY, cmd_pkt)
    ...
    # AQUI TIENE QUE IR LO DE COMPROBAR SEGUN LAS MACS Y ENVIAR
    ...
    def main(self):
        ...
        while True:
            cosa = self.device_inquiry_with_with_rssi()
            print(*cosa, sep="\n")
            print("")


if __name__ == "__main__":
    inquiry = inquiry_rssi()
    inquiry.main()